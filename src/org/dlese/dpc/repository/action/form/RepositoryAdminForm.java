 ...
 * @version    $Id: RepositoryAdminForm.java,v 1.27 2010/03/16 21:42:01 jweather Exp $
 */
	...
	public String getIndexingDaysOfWeek() {
		if (indexingDaysOfWeek == null)
			...
			for (int i = 0; i < indexingDaysOfWeek.length; i++)
				daysOfWeekMsg += Utils.getDayOfWeekString(indexingDaysOfWeek[i]) + (i == indexingDaysOfWeek.length - 1 ? "" : ", ");
