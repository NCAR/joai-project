...
<!--dc:language using languages.ISOcode-->
		<xsl:apply-templates select="ncs:general/ncs:languages/ncs:ISOcode" mode="process">
...
<!--dc:language using languages.RFCcode-->
		<xsl:apply-templates select="ncs:general/ncs:languages/ncs:RFCcode" mode="process">
			<xsl:with-param name="tag">dc:language</xsl:with-param>
